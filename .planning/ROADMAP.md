...
- [x] **Phase 4: Данные Plant Simulation** – Сквозная отладка реального запуска: формат results.txt согласован с SimTalk-макросом, числа из реальной симуляции отображаются в UI → milestone v1 закрыт
